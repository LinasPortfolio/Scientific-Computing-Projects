...
# Project details:
# The underlying idea of this project is to recommend different foods and meal compositions depending on an individual’s health status. The demonstrated approach is applicable to both humans and other mammals, such as pigs or dogs. As an example, a person with chronic kidney disease is used.
